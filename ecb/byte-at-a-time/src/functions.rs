...
pub fn detect_mode_operation(oracle: &Oracle, block_size: usize) -> aes::Mode {
    let plaintext = (0..block_size * 2 + 1).map(|_| "A").collect::<String>();
    aes::ebc_cbc_detection_oracle(oracle.encryption_oracle(plaintext), block_size)
}
...
pub fn demo() {
    let random_cipher = "YSB2ZXJ5IHNlY3JldCBtZXNzYWdlIHRoYXQgc2hvdWxkbnQgYmUgZGVjcnlwdGVkIGV2ZW4gdGhvdWdoIHdlIGFwcGVuZCB1c2VyIGlucHV0IHRvIGl0";
